...
(id, symbol, name, asset_class, market, currency, status)
VALUES
('20000000-0000-4000-8000-000000000007', 'WBTC', 'Wrapped Bitcoin', 'CRYPTO', NULL, 'USD', 'ACTIVE'),
('20000000-0000-4000-8000-000000000008', 'SOL', 'Solana', 'CRYPTO', NULL, 'USD', 'ACTIVE')
ON CONFLICT (id) DO NOTHING;
