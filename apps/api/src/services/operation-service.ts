...
import { insertEquityHolding, insertEquityPair, insertFuturesRoundTrip, insertCryptoSpot, findFuturesInstrument, findOperationById, findPosition } from "../repositories/operation-repository.js";
